...
const Drawer = ({ isLoggedIn, isOpen, handleOpenMenu }) => {
  ...
  return (
    <div className={isOpen ? "hidden" : ""}>
          ...
          {isLoggedIn ? (
            <div className="gap-8 flex flex-col text-white">
              <OutlineButton
                ...
                fontColor="#fff9fb"
              >
                <Link className="hover:text-green" href="/u/profile">
                  Profile
                </Link>
              </OutlineButton>
              <OutlineButton
            ...
            <div className="gap-8 flex flex-col text-white">
              <OutlineButton
                ...
                fontColor="#fff9fb"
              >
                <Link className="hover:text-green" href="/u/login">
                  Log in
                </Link>
              </OutlineButton>
              <OutlineButton
                ...
                fontColor="#fff9fb"
              >
                <Link className="hover:text-green" href="/u/signup">
                  Sign up
                </Link>
              </OutlineButton>
            </div>
      ...
      <div
        className="min-h-screen w-1/4 md:w-1/2 opacity-10 fixed right-0 bg-white z-10"
        onClick={handleOpenMenu}
      ></div>
    </div>
  );
